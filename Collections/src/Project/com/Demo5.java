...
//        PrintWriter writer = new PrintWriter(System.getenv("OUTPUT_PATH"), "UTF-8");
        ...
        if (outputPath == null) {
            outputPath = "output.txt"; // fallback to a default file
        }
        ...
        // Read prices
        System.out.println("Enter the number of fruits with prices:");
        int n = Integer.parseInt(reader.readLine().trim());
        System.out.println("Enter fruit names and their prices (e.g., Apple 2.5):");
        for (int i = 0; i < n; i++) {
        ...
        // Read discounts
        System.out.println("Enter the number of fruits with discounts:");
        int m = Integer.parseInt(reader.readLine().trim());
        System.out.println("Enter fruit names and their discount percentages (e.g., Apple 10):");
        for (int i = 0; i < m; i++) {
            String[] a = reader.readLine().trim().split(" ");
        ...
        System.out.println("Enter purchased items (e.g., Apple 2):");
        for (int i = 0; i < b; i++) {
            String[] a = reader.readLine().trim().split(" ");
