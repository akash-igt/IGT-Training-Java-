...
class Employee1 {
    ...
    // Constructor
    Employee1(int id, String name, int age, int salary, String designation) {
        this.id = id;
        this.name = name;
        this.age = age;
        this.salary = salary;
...
public class ProjectDemo3 {
    public static void main(String[] args) {
        ...
        HashMap<Integer, Employee1> empMap = new HashMap<>(); // Employee storage
        int choice;
        ...
        do {
            ...
            switch (choice) {
                case 1: // CREATE Employee
                    ...
                    empMap.put(id, new Employee1(id, name, age, salary, designation));
                ...
                case 3: // UPDATE Employee
                    ...
                    if (empMap.containsKey(updateId)) {
                        Employee1 emp = empMap.get(updateId);
                        sc.nextLine(); // Consume newline
